package net.sports_nutrition.criteria_filter.criteria_filter_implementation;

import net.sports_nutrition.criteria_filter.IMainCriteriaFilter;
import net.sports_nutrition.domain.entities.Product;
import net.sports_nutrition.form.beans.FormFilterBean;
import net.sports_nutrition.utils.FinderByRestriction;
